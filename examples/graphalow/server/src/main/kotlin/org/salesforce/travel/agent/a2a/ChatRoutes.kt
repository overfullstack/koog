...
data class SessionResponse(
    val session: org.salesforce.travel.agent.a2a.ChatSession
)

@Serializable
data class MessagesResponse(
    val sessionId: String,
    val messages: List<org.salesforce.travel.agent.a2a.ChatMessage>
)

fun Application.chatRoutes(chatService: org.salesforce.travel.agent.a2a.ChatService) {
    routing {
        route("/chat") {
