...
fun main() {
    val config = ApplicationConfig("application.yaml")
        .property("app")
        .getAs<org.salesforce.travel.AppConfig>()
...
fun Application.app(config: org.salesforce.travel.AppConfig) {
    install(Koog) {
        llm {
...
private fun Application.a2aMesh(config: org.salesforce.travel.AppConfig) {
