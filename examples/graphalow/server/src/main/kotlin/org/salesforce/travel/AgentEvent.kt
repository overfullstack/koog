...
typealias SerializableImmutableList<T> = @Serializable(_root_ide_package_.org.salesforce.travel.ImmutableListSerializer::class) ImmutableList<T>
...
sealed interface AgentEvent {
    ...
    @SerialName("finished")
    @Serializable
    data class AgentFinished(val agentId: String, val runId: String, val plan: org.salesforce.travel.dto.ProposedTravelPlan) : AgentEvent
    ...
    @SerialName("step1")
    @Serializable
    data class Step1(val ideas: List<org.salesforce.travel.dto.PointOfInterest>) : AgentEvent

    @SerialName("step2")
    @Serializable
    data class Step2(val researchedPointOfInterest: org.salesforce.travel.dto.ResearchedPointOfInterest) : AgentEvent
}
...
data class JourneyForm(
    val fromCity: String,
    val toCity: String,
    val transport: org.salesforce.travel.TransportType,
    val startDate: LocalDateTime,
    val endDate: LocalDateTime,
    val travelers: org.salesforce.travel.SerializableImmutableList<org.salesforce.travel.Traveler>,
    val details: String?,
)
