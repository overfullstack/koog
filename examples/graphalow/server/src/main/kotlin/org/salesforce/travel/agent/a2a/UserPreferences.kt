...
enum class ConversationState {
    ...
    PLANNING, PRESENTING_PLAN, REFINING_PLAN, FOLLOW_UP, AWAITING_SUGGESTION_RESPONSE,
    AWAITING_BRANCH_SELECTION, AWAITING_TIMESLOT_CONFIRMATION, AWAITING_BOOKING_CONFIRMATION
}
